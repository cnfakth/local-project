        ...
        <div className="flex items-center gap-6">
          ...
          {user ? (
            <div className="flex items-center gap-3">
              ...
              <div
                className="p-2 rounded-lg outline outline-1 outline-offset-[-1px] outline-gray-300 bg-gray-100 text-base text-gray-700 font-normal text-center cursor-pointer"
